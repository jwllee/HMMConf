...
public class SyncProductPrefixImpl implements SyncProduct {
	...
	public SyncProductPrefixImpl(String label, int numClasses, String[] transitions, String[] places, int[][] eventNumbers,
